  ...
  <div class="bg row">
    ...
    <v-dialog v-model="flag" max-width="500" v-else>
      <v-card>
        ...
        <v-img height="250" src="https://pic-go-noir.oss-cn-beijing.aliyuncs.com/studentmanger/%5Byande%5D597320.png"></v-img>
        <v-card-text>
          现在进入我的博客
        </v-card-text>
        <v-divider></v-divider>
...
.bg{
    width: 100%;
    height: 100vh;
    background: url(https://pic-go-noir.oss-cn-beijing.aliyuncs.com/bgi/1.jpg);
}
.mask{
