        ...
        <v-row>
            <v-col cols="12" md="8" class="left px-6">
                ...
                <v-row class="pl-6 mt-10 grey--text">
                    ...
                    <span class="text-md-h6 font-weight-mediu mr-3">发布日期：{{article.publishDate}}</span>
                    <!-- 作者 -->
                    <v-icon class="mr-1">
                        mdi-account
                    </v-icon>
                    <span class="text-md-h6 font-weight-mediu mr-3">作者:{{article.nickname}}</span>
                     <!-- 文章字数 -->
                    <v-icon class="mr-1">
                        mdi-file
                    </v-icon>
                    <span class="text-md-h6 font-weight-mediu mr-3">文章字数:{{article.totalWords}}</span>
                     <!-- 阅读时长 -->
                    <v-icon class="mr-1">
                        mdi-clock
                    </v-icon>
                    <span class="text-md-h6 font-weight-mediu mr-3">阅读时长:{{article.duration}}</span>
                     <!-- 阅读次数 -->
                    <v-icon class="mr-1">
                        mdi-eye
                    </v-icon>
                    <span class="text-md-h6 font-weight-mediu mr-3">阅读次数:{{article.pageView}}</span>
                </v-row>
                <!-- 分割线 -->
            ...
            <v-col cols="12" md="4" class="pa-12">
                <v-row align="end" class="ml-12">
                    <v-icon class="mr-3 text-md-h4">
                        mdi-format-list-bullete-square
                    </v-icon>
...
export default {
  ...
  computed: {
    ...mapState({
      loginStatues: (state) => state.loginStatues,
...
.main{
    ...
    .left{
        box-shadow: 0 10px 35px 2px rgba(0,0,0,.15),0 5px 15px rgba(0,0,0,0.07),0 2px 5px -5px rgba(0,0,0,.1) !important;
