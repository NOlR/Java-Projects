	...
	<view>
		...
		<view class="flex justify-start align-center px-3 flex-wrap">
			...
			<uni-tag
				...
				class="mr-1 mb-1"></uni-tag>
		</view>
		
		<uni-collaspe accordion="true">
			<uni-collaspe-item title="请选择" class="ml-1 font-lg">
				<view class="flex justify-start align-center px-3 flex-wrap">
					<uni-tag
		...
		<jinEdit
			...
			@editOk="submit"
			fileKeyName="file"
			uploadFileUrl = "http://vue-vlog.cn.utools.club/api/user/upload"></jinEdit>
	</view>
</template>

<script>
import uniListItem from '@/components/uni-ui/uni-list-item/uni-list-item.vue';
import uniCollaspe from '@/components/uni-ui/uni-collapse/uni-collapse.vue';
import uniCollaspeItem from '@/components/uni-ui/uni-collapse-item/uni-collapse-item.vue';
...
export default {
	...
	methods: {
		...
		submit(res){
			...
			let list =[];
			//注意element为Tag对象,需要取出其tagName属性
